...
final class SignUpViewController: BaseViewController {
	...
	private lazy var emailLabel = UILabel().then {
		...
		attribtuedString.addAttribute(.font, value: UIFont.Pretendard.m18, range: titleRange)
		attribtuedString.addAttribute(.foregroundColor, value: UIColor.label, range: titleRange)
		
		attribtuedString.addAttribute(.font, value: UIFont.Pretendard.m14, range: subRange)
